...
import { createCoordSendTool, createCoordHistoryTool, createWorkspaceToolFactories } from "./tools.js";
...
export default function register(api: OpenClawPluginApi) {
  ...
  // Register inter-agent coordination tools (static)
  api.registerTool(createCoordSendTool());
  api.registerTool(createCoordHistoryTool());

  // Register workspace tools (dynamically discovered from Dyad MCP endpoint)
